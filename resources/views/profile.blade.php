            ...
            <div class="col-md-4">
                ...
                <div class="card shadow-sm text-center">
                    <div class="card-body">
                        ...
                        <div class="rounded-circle bg-primary text-white d-inline-flex align-items-center justify-content-center mb-3" style="width: 100px; height: 100px;">
                        ...
                        <div class="list-group mt-4 text-start">
                            <a href="#" class="list-group-item list-group-item-action active" aria-current="true">Profil Saya</a>
                            ...
                            <a href="#" class="list-group-item list-group-item-action text-danger fw-medium">Keluar</a>
                        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control bg-light" value="{{ $user->name ?? 'buelizbaik' }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold small text-muted">Email</label>
                                <input type="email" class="form-control bg-light" value="{{ $user->email ?? 'buelizbaik@email.com' }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold small text-muted">Nomor Telepon</label>
                                <input type="text" class="form-control bg-light" value="{{ $user->phone ?? '08234567890' }}" readonly>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold small text-muted">Alamat</label>
                                <input type="text" class="form-control bg-light" value="{{ $user->address ?? 'Jl. in aja dulu' }}" readonly>
                            </div>
                        </div>
